...
@IMB_ALGORITHMS.register('abc_iac')
class ABC_IAC(ImbAlgorithmBase):
    def __init__(self, args, net_builder, tb_log=None, logger=None, **kwargs):
        self.imb_init(abc_p_cutoff=args.abc_p_cutoff, abc_loss_ratio=args.abc_loss_ratio)
        super(ABC_IAC, self).__init__(args, net_builder, tb_log, logger, **kwargs)
        self.rou_iac = 1.8
